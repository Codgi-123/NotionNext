...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Codgi', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '近朱者赤，近墨者黑', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.codgi.xin', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Codgi, 博客', // 网站关键词 英文逗号隔开
